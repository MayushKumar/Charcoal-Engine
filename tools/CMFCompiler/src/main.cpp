...
int main(int argc, char* argv[])
{
	...
	std::string filePath = "../../Sandbox/assets/models/cerberus/gltf/Cerberus.gltf";
#else
...
void WriteToFile(CMFFormat& format)
{
	...
	for (uint32_t i = 0; i < format.MaterialCount; i++)
	{
		...
		fileStream.write((const char*)&format.Materials[i].BaseColour, sizeof(format.Materials[i].BaseColour));
