...
void Sandbox3D::OnAttach()
{
	...
	// m_Models.push_back(Charcoal::ModelManager::LoadModel("assets/models/cerberus/gltf/Cerberus.cmf"));
	// m_Models.push_back(Charcoal::ModelManager::LoadModel("assets/models/gold/gold.cmf"));
	m_Models.push_back(Charcoal::ModelManager::LoadModel("assets/models/brass_vase/brass_vase_03_2k.cmf"));
	// m_Models.push_back(Charcoal::ModelManager::LoadModel("assets/models/cube/cube.cmf"));
...
void Sandbox3D::OnImGuiRender()
{
	...
	ImGui::Text("Recompile Shaders: ");
	for(auto i = Charcoal::ShaderManager::shader_map.begin(); i != Charcoal::ShaderManager::shader_map.end(); ++i)
	{
		if(ImGui::Button(i->first.c_str()))
		{
			i->second->ReadAndCompile();
		}
	}
